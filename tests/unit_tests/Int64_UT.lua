...
unit_tests:addTest("Testing wirebait Int64.new(NEGATIVE low_num)", function()
    local success, error_msg = pcall(Int64.new, -1);
...
unit_tests:addTest("Testing wirebait Int64.new(NAN low_num)", function()
    local success, error_msg = pcall(Int64.new, "not a number");
...
unit_tests:addTest("Testing wirebait Int64.new(NIL low_num)", function()
    local success, error_msg = pcall(Int64.new);
...
unit_tests:addTest("Testing wirebait Int64.new(TOO LARGE low_num)", function()
    local success, error_msg = pcall(Int64.new, UINT32_MAX + 1);
...
unit_tests:addTest("Testing wirebait Int64.new(low_num, NEGATIVE high_num)", function()
    local success, error_msg = pcall(Int64.new, 1, -1);
...
unit_tests:addTest("Testing wirebait Int64.new(low_num, NAN high_num)", function()
    local success, error_msg = pcall(Int64.new, 1, "not a number");
...
unit_tests:addTest("Testing wirebait Int64.new(low_num, TOO LARGE high_num)", function()
    local success, error_msg = pcall(Int64.new, 1, UINT32_MAX + 1);
...
unit_tests:addTest("Testing wirebait Int64.fromByteArray(00) = 0", function()
    ...
    local int_64 = Int64.fromByteArray(b);
...
unit_tests:addTest("Testing wirebait Int64, 1 + 1 = 2", function()
    local int_64 = Int64.new(1) + Int64.new(1);
...
unit_tests:addTest("Testing wirebait Int64, UINT32_MAX + 1 = 4294967296", function()
    local int_64 = Int64.new(UINT32_MAX) + Int64.new(1);
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1 + 0xFF24FF01 = 8572300530", function()
    local int_64 = Int64.new(0xFFCDEDF1) + Int64.new(0xFF24FF01);
...
unit_tests:addTest("Testing wirebait Int64, UINT32_MAX + UINT32_MAX = 8589934590", function()
    local int_64 = Int64.new(UINT32_MAX) + Int64.new(UINT32_MAX);
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF + 0xFF24FF01/0x1234 = 301493801643250", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF) + Int64.new(0xFF24FF01, 0x1234);
    tester.assert(tostring(int_64), "301493801643250", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, UInt64_MAX + 1 = -9223372036854775808 (Wraparound)", function()
    local int_64 = Int64.new(UINT32_MAX, 0x7FFFFFFF) + Int64.new(1);
    tester.assert(tostring(int_64), "-9223372036854775808", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, UInt64_MAX + 0xAF = 174 (Wraparound)", function()
    local int_64 = Int64.new(UINT32_MAX, UINT32_MAX) + Int64.new(0xAF);
    tester.assert(tostring(int_64), "174", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, UInt64_MAX + 0x01FFFFFFFF = 8589934590 (Wraparound)", function()
    local int_64 = Int64.new(UINT32_MAX, UINT32_MAX) + Int64.new(UINT32_MAX, 0x01);
    tester.assert(tostring(int_64), "8589934590", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, UInt64_MAX + 0xFFFFFFFF/0xFFFF = 281474976710654 (Wraparound)", function()
    local int_64 = Int64.new(UINT32_MAX, UINT32_MAX) + Int64.new(UINT32_MAX, 0xFFFF);
    tester.assert(tostring(int_64), "281474976710654", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, UInt64_MAX + UInt64_MAX = -2 (Wraparound)", function()
    local int_64 = Int64.new(UINT32_MAX, UINT32_MAX) + Int64.new(UINT32_MAX, UINT32_MAX);
    tester.assert(tostring(int_64), "-2", "Wrong addition result!");
  end);

unit_tests:addTest("Testing wirebait Int64, 0x04 - 0x02 = 2", function()
    local int_64 = Int64.new(0x04) - Int64.new(0x02);
    tester.assert(tostring(int_64), "2", "Wrong substraction result!");
  end);

unit_tests:addTest("Testing wirebait Int64, 0x02 - 0x03 = -1", function()
    local int_64 = Int64.new(0x02) - Int64.new(0x03);
    tester.assert(tostring(int_64), "-1", "Wrong substraction result!");
  end);

unit_tests:addTest("Testing wirebait Int64, 0x02 - 0x02 = 0", function()
    local int_64 = Int64.new(0x02) - Int64.new(0x02);
    tester.assert(tostring(int_64), "0", "Wrong substraction result!");
  end);

unit_tests:addTest("Testing wirebait Int64, 0x02 -  0x00000000/0x01 = -4294967294", function()
    local int_64 = Int64.new(0x02) - Int64.new(0,1);
...
unit_tests:addTest("Testing wirebait Int64, Int64_MAX - (Int64_MAX - 1) = 0", function()
    local int_64 = Int64.new(UINT32_MAX,UINT32_MAX) - Int64.new(UINT32_MAX-1,UINT32_MAX);
    tester.assert(tostring(int_64), "1", "Wrong substraction result!");
  end);

unit_tests:addTest("Testing wirebait Int64, (UInt64_MAX - 1) - UInt64_MAX = -1", function()
    local int_64 = Int64.new(UINT32_MAX-1,UINT32_MAX) - Int64.new(UINT32_MAX,UINT32_MAX);
    tester.assert(tostring(int_64), "-1", "Wrong substraction result!");
  end);

unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF - 0xFF24FF01/0x1234 = 261456145215216", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF) - Int64.new(0xFF24FF01, 0x1234);
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1 & 0xFF24FF01 = 4278512897", function()
    local int_64 = Int64.new(0xFFCDEDF1):band(Int64.new(0xFF24FF01));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF & 0xFF24FF01/0x1234 = 20018826112257", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):band(Int64.new(0xFF24FF01, 0x1234));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF & 0xFF24FF01/0x1234 & 0x4DA3 = 19713", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):band(Int64.new(0xFF24FF01, 0x1234), Int64.new(0x4DA3));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1 | 0xFF24FF01 = 4293787633", function()
    local int_64 = Int64.new(0xFFCDEDF1):bor(Int64.new(0xFF24FF01));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF | 0xFF24FF01/0x1234 = 281474975530993", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):bor(Int64.new(0xFF24FF01, 0x1234));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF | 0xFF24FF01/0x1234 | 0x4DA3 = 281474975530995", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):bor(Int64.new(0xFF24FF01, 0x1234), Int64.new(0x4DA3));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1 ~ 0xFF24FF01 = 15274736", function()
    local int_64 = Int64.new(0xFFCDEDF1):bxor(Int64.new(0xFF24FF01));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF ~ 0xFF24FF01/0x1234 = 261456149418736", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):bxor(Int64.new(0xFF24FF01, 0x1234));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF ~ 0xFF24FF01/0x1234 ~ 0x4DA3 = 261456149438291", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):bxor(Int64.new(0xFF24FF01, 0x1234), Int64.new(0x4DA3));
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF >> 2 = 70368743357308", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):rshift(2);
...
unit_tests:addTest("Testing wirebait Int64, 0xFFCDEDF1/0xFFFF << 2 = 1125899893716932", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF):lshift(2);
...
unit_tests:addTest("Testing wirebait Int64, ~0xFFCDEDF1/0xFFFF = 1125899893716932", function()
    local int_64 = Int64.new(0xFFCDEDF1, 0xFFFF0000):bnot();
